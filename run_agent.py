...
class AIAgent:
    ...
    def _dispatch_delegate_task(self, function_args: dict) -> str:
        ...
        # Normal top-level MODEL delegations detach. Nested subagents and
        # dispatcher-spawned Kanban workers run synchronously so their bounded
        # lifecycle can consume and act on the child result before exit.
        return _delegate_task(
            ...
            review=bool(function_args.get("review", False)),
